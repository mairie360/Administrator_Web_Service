-- Seed minimal pour les tests isolés (performance / sécurité) du front Administration.
...
-- Le rôle "User" ne donne pas l'accès admin : les routes /bff/admin/* restent
-- refusées en 403 (comportement attendu, pas une faille).
